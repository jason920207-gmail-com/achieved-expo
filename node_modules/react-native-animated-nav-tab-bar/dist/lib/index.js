...
function ResourceSavingScene(_a) {
    ...
    if ((reactNativeScreens.screensEnabled === null || reactNativeScreens.screensEnabled === void 0 ? void 0 : reactNativeScreens.screensEnabled()) && reactNative.Platform.OS !== 'web') {
        return (React.createElement(reactNativeScreens.Screen, __assign({ activityState: isVisible ? 2 : 0, style: style }, rest), children));
    }
    return (React.createElement(reactNative.View, { style: [
        ...
        React.createElement(reactNative.View, { collapsable: false, removeClippedSubviews: 
